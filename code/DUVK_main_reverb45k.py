...
if __name__ == '__main__':
    ...
    parser.add_argument('--use_semantic', default=True)
    ...
    parser.add_argument('-b1', '--single_batch_size', default=128, type=int)
    parser.add_argument('-b2', '--cross_batch_size', default=128, type=int)
    ...
    duvk = DUVK_Main(args)  # Loading KG triples
    duvk.get_sideInfo()  # Side Information Acquisition
    duvk.embedKG()  # Learning embedding for Noun and relation phrases